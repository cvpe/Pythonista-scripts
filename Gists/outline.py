...
todo 
====
https://forum.omz-software.com/topic/7110/outliner-with-drag-drop-reordering/372
- .. bug: if automatic linefeed, try to intercept it and recompute row height
- .. bug: force download icloud file startDownloadingUbiquitousItem(at:)
...
- .. bug: in split view, no automatic linefeed for me but @ihf has it
...
class Outliner(ui.View):
	...
	def tableview_cell_for_row(self, tableview, section, row):
		...
		bb.text_color = 'blue'
		bb.font = ft
		wo,ho = ui.measure_string(txt, font=ft, max_width=self.width-x)
