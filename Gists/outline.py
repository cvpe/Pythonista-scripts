...
todo 
====
- .. bug: device id of on my ipad
		
		/private/var/mobile/Containers/Shared/AppGroup/1B829014-77B3-4446-9B65-034BDDC46F49/File Provider Storage/
		
		local ['/private/var/mobile/Containers/Shared/AppGroup/1B829014-77B3-4446-9B65-034BDDC46F49/Pythonista3/Documents/aa.py']
...
class Outliner(ui.View):
	def __init__(self, *args, **kwargs):
		...
		device_id_onmy  = '?'#EF3F9065-AD98-4DE3-B5DB-21170E88B77F'
		self.folders = {'local':'/private/var/mobile/Containers/Shared/AppGroup/'+device_id_local+'/Pythonista3/Documents/', 'iCloud':'/private/var/mobile/Library/Mobile Documents/iCloud~com~omz-software~Pythonista3/Documents/', 'on my\n' + self.device_model:'/private/var/mobile/Containers/Shared/AppGroup/'+device_id_onmy+'/File Provider Storage/', 'iCloud\nDrive':'/private/var/mobile/Library/Mobile Documents/com~apple~CloudDocs/'}
