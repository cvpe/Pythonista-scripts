...
todo 
====
- .. bug: file_picker on iphone crashs
- .. bug: select row tHat will be hidden by keyboard, no automatic scroll
...
class Outliner(ui.View):
	def __init__(self, *args, **kwargs):
		...
		if self.device_model != 'iPhone':
			if 'on_my_path' in self.prms:		
				self.path_to_name[path_on_my] = 'On my ' + self.device_model
		
			self.path_to_name['/private/var/mobile/Library/Mobile Documents/com~apple~CloudDocs/'] = 'iCloud Drive'
	...
	def textview_did_begin_editing_unused(self, textview):
