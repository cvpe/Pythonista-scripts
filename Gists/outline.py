...
- bug: 0️⃣ if I turn on "1st level has outline" it turns itself back off
					after I leave the menu. iPhone only
- bug: 0️⃣ I know you’re not thrilled to hear about bugs 
					but just now I opened an outline and double clicked on a word in the last item and the keyboard appeared (portrait mode on iPhone) and covered the line that I was editing
