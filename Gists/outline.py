...
- new: 0️⃣ After selecting the file, might be nice to have it do the search within
					...
					- flag
					- simul button search text
					- end of pick_open_callback
					- fill textfield
					- simul textdidchange, check if not already called
