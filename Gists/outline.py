...
todo 
====
- .. bug: drop under outline which has children, these are not renumbered

- .. renumbering all appelé a chaque operation?
			avance dans tout, si meme level que precedent, alors + 1
...
class Outliner(ui.View):
	...
	def set_outline_attributes(self):			
		...
		# ui.View covering outline				
		for sv in self.tv.subviews:
			if isinstance(sv, ui.View):
