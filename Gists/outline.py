...
todo
====
- bug: 0️⃣ arg 1 = file to open does not work since date-time added
					lsdir, if several newest date time
- new: 0️⃣ tab and shift/tab for external keyboard
					blackmamba ctrl/left and /right
- new: 1️⃣ Wish list: mail/pushover/notification on due date/time
						- create calendar event with alarm notification for the due date
						- remove if due date unset, changed, reached since some time
