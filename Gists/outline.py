...
todo 
====
- .. bug: 0️⃣ even with date, all must remain editable, quid width?
- .. bug: 0️⃣ the label at top left showing which date field is shown is 
					partially cutoff on iPhone/ipad  in portrait mode.
...
- .. new: 2️⃣ views on dates: sort on dates
- .. new: 3️⃣ photos
