...
- .. renumbering after delete for move text
- .. long lines, auto lf not visible, quid if fontsize changes
- ..	- ?
-	.. lf insert
...
- .. 🔟search text, show only items containing search and their parents
