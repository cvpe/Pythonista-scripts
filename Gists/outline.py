...
- bug: 0️⃣ undo: bad successive (ex: font)
					...
					- setting? multiple undo yes/no or maximum number of successive?
...
- new: 🔟 - color of line of strikethrough and underline
						- round button with coloured background at each line except bold/italic
...
Version V00.78
  ...
  - correction of bug "insert/update in attribued portion of text looses the cursor"
