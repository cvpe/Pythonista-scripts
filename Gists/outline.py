...
====
- .. bug: ...
- .. bug: file_picker (for open)  on iphone locks not only on icloud 
					but also in local
					when I try to do an open from my iPhone, no response and the script never presents the file picker and it can’t be closed. I’ve deleted the .prm file and restarted Pythonista but it did not help.
