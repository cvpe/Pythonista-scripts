...
todo 
==== 
- new: 0️⃣ After selecting the file, might be nice to have it do the search within
					the file as if you had used the magnifying glass on the open file
...
class Outliner(ui.View):
	...
	def pick_open_callback(self,param):
		...
		#..........
		return
		self.button_search_action(self['b_search'])
