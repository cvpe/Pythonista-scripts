...
todo 
====
- .. bug: I opened an outline with v0.46 on the iPhone and with the keyboard 
					on the bottom half of the screen I was not able to scroll the outline up so that I could see what I was typing in a new entry.
					====== add key dismiss
- .. bug: in split view, no automatic linefeed while @ihf has it
...
- .. new: access local, icloud in the same File_Picker
					- file picker array of dirs, gray of not accessible
						local: Documents
						iCloud:
