...
todo 
==== 
- bug: 0️⃣ menu fonT does not appear
- new: 0️⃣ automatic download of some needed files
					or script to install all including outline.py
- bug: 0️⃣ enter generates a new line but should put cursor on it
...
#========= needed import modules
def needed_modules():
	print('Needed files')
	print('============')
	print('SetTextFieldPad.py at https://github.com/cvpe/Pythonista-scripts/blob/master/SetTextFieldPad.py')
	print('File_Picker.py     at https://github.com/cvpe/Pythonista-scripts/blob/master/File_Picker.py')
	print('gestures.py        at https://github.com/mikaelho/pythonista-gestures/blob/master/gestures.py')
	print('blackmamba folder  at https://github.com/zrzka/blackmamba/tree/master/blackmamba')
	print('swizzle.py         at https://github.com/jsbain/objc_hacks/blob/master/swizzle.py')
	print('\nall previous modules should be copied in site-packages\n')
	print('outline.versions   at https://github.com/cvpe/Pythonista-scripts/blob/master/Gists/outline.versions')
