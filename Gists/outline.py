...
todo 
====
- .. bug: 0️⃣ When I open my outline, sometimes the keyboard appears 
					before I touch the outline. scroll top => keyboard
					*** review use of setcursor
- .. bug: 0️⃣ if I then scroll up to find the text where I wish to do an insert,
					Pythonista will crash immediately.
...
- .. new: 2️⃣ views on dates: sort asc, desc, alpha (which, how)
...
Version V00.63
  - a lot of crashes "Segmentation fault" occur after scroll which set the cursor,
    ...
    Try to protect against these crashed by no more showing cursor/keyboard 
...
class Outliner(ui.View):
	...
	def tableview_cell_for_row(self, tableview, section, row):
		...
		if row == self.cursor[0] and self.undo_multiples[-1][0] == 'CR':
			bb.begin_editing()
