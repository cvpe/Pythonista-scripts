...
- .. new: I think the "triangle" symbol to the letf of the outline item should
					point down when the children are visible and and to the right when they are hidden. Moreover, it would be even nicer if that symbol was different (perhaps a solid circle?) when there are no children.
...
class Outliner(ui.View):
	...
	def textview_did_begin_editing(self, textview):
		...
		if yp > self.keyboard_y:
			...
			#print('after',self.tv.content_offset[1])
			#self.tvo.contentOffset().y = y
