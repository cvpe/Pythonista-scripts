...
todo
====
- .. 0️⃣bug: 3.0 lf generates 4.0 but lines after are not renumbered
- .. 0️⃣bug: incorrect renumbering lines after lf
- .. 0️⃣bug: renumbering when drop before first line
- .. 0️⃣bug: drop after all lines does not do anything
- .. drop with copy, not move, thus not delete original
- .. renumbering after delete in should_change
- .. renumbering after delete of original moved text
...
class Outliner(ui.View):
	...
	def textview_should_change(self, textview, range_c, replacement):
		...
		#print(dir(ObjCInstance(textview)))
