...
todo 
====	
- .. bug: ❗️type => scroll weird when typing (workaround active)

- .. new: autosave each character? could be heavy, check time save file+content
					- settings: immediately, each enter/tab/backtab, each n characters
						- show last save time
					- del file.old and file.content.old
					- ren files as .old
					- save
					ask @ihf if he would like (tab/backtab/enter only?)
					=========================
					
- .. new: why not have the user specify a name and location when they save (could be reminded at exit?). I prefer to be able to start the script and just begin writing rather than naming the file, selecting its location, changing font prefs, etc.
		- not if autosave
		- new file: not ask folder and name now
		- name =? as view title
		- when save, ex: at end, folder and name
