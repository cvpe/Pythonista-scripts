...
def file_picker_dialog(title=None, root_dir=None, multiple=False,
                       select_dirs=False, file_pattern=None, show_size=True, from_dialog=None, icloud=False, callback=None):
	if root_dir is None:
...
def main():
	py_files = file_picker_dialog('Pick some .py files', multiple=False, select_dirs=True)#, file_pattern=r'^.*\.py$')
