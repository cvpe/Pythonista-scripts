''' 
version 00.30 is available with

modifications
  - programmed voiceover texts for Caps and Capslock keys
  - programmed read alpud texts for 
    voiced and semi-voiced sound marks, 
    comma and point punctuations
...
class MyView(ui.View):
	...
	def long_press_handler(self, data):
		...
		if data.state == 1:
			...
			#	speech_say('no key typed', language='en-GB')									
