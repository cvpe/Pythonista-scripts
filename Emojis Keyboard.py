'''
V00.17
	- new order and title of keys
	- automatically compute font size of keys titles
	- voiced, semi-voiced, punctuation, small keys also for Katakana
	- order of sub-keys of a flicking key is clockwise, this has obliged alphabet
		rows to be one row below
	- new key: "small key" but process not yet programmed
todo	

	- lowercase: 0x3042 -> あ  0x3041 -> ぁ 
		
		Hiragana and katakana used for lower case letters are as follows.

		“ぁ”,”ぃ”,”ぅ”,”ぇ”,”ぉ”,”ゃ”,”ゅ”,”ょ”,”ゎ”
		“ァ”,”ィ”,”ゥ”,”ェ”,”ォ”,”ャ”,”ュ”,”ョ”,”ヮ”
		

		I want it to be able to input only the characters that will become smaller when you press the button. Is it possible?

		The target buttons are "あ", "や", "わ "," ア "," ヤ ", and" ワ ".
...
class MyView(ui.View):
	...
	def dimensions(self):				
		...
		self.v_kanji.background_color = self.background_color
		...
		# “カタカナ”,”⬅️”,”文頭”,”⬆️”,”文末”,”➡️”,”左削除”
		# “アルファベット”,”あ”,”か”,”さ”,”た”,”な”,゛゜”
		# “数字”,”は”,”ま”,”や”,”ら”,”わ”,”漢字”
		# “絵文字”,”小文字”,”read to cursor “,”⬇️”,”read all “,”。、”,”return “
		...
		for kbd in keyboards.keys():		
			for ix,iy,t,act,flick in keyboards[kbd]:
				...
				#if t in ['アルファベット','数字','絵文字','⬆️','⬅️','⬇️','➡️', '⇧', '⇪'] or len(t) == 1:
		...
		#self.small_keys = {"あ":"ぁ", "や":"ゃ", "わ":"ゎ", "ア":"ァ", "ヤ":"ャ", "ワ":"ヮ", "た":"タ"}			
		#self.small = False
		#self.b_japan_action('unused')
		...
		for b in v.subviews:
			if isinstance(b, ui.Button):
				if b.title == '小文字': # small keys
					b.background_color = 'white' if self.small else 'lightgray'
				elif b.title not in self.small_keys.keys():
					b.hidden = True if self.small else False
