...
- after tapping the "small keys"  button and returning to the original keyboard,
	the color button has changed
- when adding the  ゙ accent, do not append it to the character but replace the
...
# かんじ 冠詞	
		...
		for kbd in keyboards.keys():		
			for ix,iy,t,act,flick in keyboards[kbd]:
				...
				if flick:
					long_press(b,self.long_press_handler, minimum_press_duration=0.05)
