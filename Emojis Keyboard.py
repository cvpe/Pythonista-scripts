'''
todo
	- I want all the buttons on the cursor movement screen to be rectangular instead
		of square, so that it fills all the keyboard space. I want the number and alphabet buttons to be the same size as the cursor movement buttons after the change.
 	- I forgot the important flick input button.
		It is a Katakana flick input button.
		I want the buttons to be arranged in the same way as Hiragana.
		Please make the switch button the same as the alphabet. And please place it on the switch button of alphabet
