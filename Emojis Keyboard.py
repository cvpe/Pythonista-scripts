...
class MyView(ui.View):
	...
	def dimensions(self):				
		...
		keyboards = {'japan':[
			...
			[4,0,'サ',self.typeChar,'しすせそ'],
			[2,1,'た',self.typeChar,'シスセソ'],						
			[3,1,'タ',self.typeChar,'チツテト'],						
			[4,1,'ナ',self.typeChar,'ニヌネノ'],				
			[2,2,'ハ',self.typeChar,'ヒフヘホ'],						
			[3,2,'マ',self.typeChar,'ミムメモ'],						
			[4,2,'ヤ',self.typeChar,'「ユ」ヨ'],
			[2,3,'ラ',self.typeChar,'リルレロ'],				
