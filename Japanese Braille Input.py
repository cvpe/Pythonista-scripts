...
# - bug: 1 2 3 affiche 2 3, perte de dots?
#				 parce que nouveau doigt avec meme touch_id
# - dimensions calculees pas settees pour vrai keyboard
# - read/save/set settings
# - ask si prefere scrollview horozontale avec les kanjis en boutons
...
class BrailleKeyboardInputAccessoryViewForTextField(ui.View):
	...
	def draw_hirganas(self):
		...
		self['b_conversion'].hidden = False
