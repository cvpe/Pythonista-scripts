...
class BrailleKeyboardInputAccessoryViewForTextField(ui.View):
	...
	def dimensions(self):		
		...
		b1.image = ui.Image.named('iob:arrow_up_a_32')
		...
		b2.image = ui.Image.named('iob:checkmark_round_32')
		...
		b3.image = ui.Image.named('iob:arrow_down_a_32')
	...
	def tableview_say_current(self):
		...
		utterance.rate = 0.5
		utterance.voice = voices[31] # Japon = 31,32,33
