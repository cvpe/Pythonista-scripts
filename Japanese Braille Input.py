...
# - new: buttons up,ok, down in conersion list will have as variable title
...
# still todo
# ==========
# - new: titles of buttons so VoiceOver will speach them, instead of icons
# - how to select element like one tap with voiceover
#		or ask if objetivec speech not ok?
...
#		- modify/save sttings
# - ask #shinya.ta if he prefers the 6 fingers together?
import ast
import console
...
class BrailleKeyboardInputAccessoryViewForTextField(ui.View):
	...
	def get_kanji(self,delta):
		...
		return self['kanjis'].data_source.items[i]
