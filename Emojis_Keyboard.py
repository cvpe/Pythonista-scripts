''' 
version 00.34 is available with

modifications
  - change the display of the button to return 
    to the Hiragana page from each page to "平仮名"  
  - place the buttons on the Katakana page at the same height 
		as the Hiragana page. 		 
  - place the buttons on all other pages at the same height 
		as the Hiragana page.
  - put the button to go back to the Hiragana page from the Katakana page 
    in the same place as the "カタカナ" button on the Hiragana page. 	
  - phrases sub-keyboard with large buttons to fill screen,
    but only 4 rows of buttons and 5 phrases => 2 columns	 
...
class MyView(ui.View):
	...
	def dimensions(self):				
		...
		keyboards = {'hiragana':[
			...
			[1,2,'こんちには✨',self.typeChar,''],
			[1,3,'こんばん”🌙',self.typeChar,''],
