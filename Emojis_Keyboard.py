''' 
version **00.51** is available with

modifications
  - layout of the Katakana page the same as Hiragana.
    3rd line: 数字,平仮名,マ,ヤ,ラ
    4th line= 絵文字,小文字,濁点,ワ,、。,記号,“ return
  - input the buttons of symbols other than numbers on the page 	
		of numbers directly instead of putting them in the temporary storage.
