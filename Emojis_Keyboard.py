''' 
version **00.37** is available with

modifications
  - add ”(”,”)” in symbols sub-keyboard
  - particular read aloud for two symbols sub-keys of "や" Hirgana letter
      “「”→”ひだりかぎかっこ”
      “」”→”みぎかぎかっこ”
  - add "return" key in digits sub-keyboard
