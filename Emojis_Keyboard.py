''' 
version **00.38** is available with

modifications
  - try new Hirgana layout allowing flicking in first line
    First line. “文頭”,”←”,”あ”,”か”,”さ”,”→”,”文末”
    Second line. “ABC”,”read to cursor”,” た”,”な”,”は”,”read all” + left delete
    Third line. “数字”,”記号”,”ま”,”や”,”ら”,”定型文”,”漢字”
    Fourth line. “絵文字”,”カタカナ”,”小文字”,”わ”,”。、”,”濁点”,”return”
		only Hirgana keyboard is modified as a trial
	- left alignment in temporary storage to see it even if flicked letters
...
todo
	...
	- Also, can you lower the placement of buttons to the limit?
		Is it possible to enlarge the button size as much as possible?
