''' 
version **00.42** is available with

modifications
  - add return button in small keys page

corrections
  - the space button on the alphabet page generates a "s" instead of a blank
