''' 
version **00.48** is available with

modifications
  - remove magnification of flicked sub-keys versus flicking key size
  - reset the long press duration from 0.1 to 0.01 second
    but so, no real way to really tap on the flicking key 
    your finger always stays more than a 0.01 second on the screen,
    thus a tap is processed as a very short (long) press
