''' 
version 00.31 is available with

modifications
  - read aloud '。' as "period"
	- read aloud '、' as "reading point"
  - read all       => read current line
  - read to cursor => read from begin of line to cursor
	- move up   ⬆️   => locate cursor at begin of line
		move down ⬇️   => locate cursor at end of line
...
but, do you still need these other two buttons:
- '文頭' = top, similar to up
- '文末' = bottom, similar to down 
