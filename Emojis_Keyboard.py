''' 
version **00.41** is available with

modifications
  - small letters, still to be done

corrections
  - for sone Hirgana letters, you can only input the middle and upper buttons
    by flicking, you cannot input the left, right, and lower buttons
  - on the alphabet page, you can only input the up button of some flick 
    input buttons.
...
todo
	...
	- Can I change the small letter button to act like a shift button?	
		It would be convenient if there is a function that allows you to enter only valid characters and only small letters by pressing the shift button.
		If you can do that, you can get rid of lower case pages.
...
class MyView(ui.View):
	...
	def dimensions(self):				
		...
		keyboards = {'hiragana':[
			...
			[0,3,'絵文字', self.b_emoji_action,''],
			[1,3,'平仮名', self.b_hiragana_action,''],
			[2,3,'小文字',self.smallKey,''],
