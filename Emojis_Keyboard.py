...
todo
	...
	- When you tap the button and flick your finger at the same time, the text 
		selection will turn blue. Starts to read at the same time.
		...
		Of all the flick input buttons, the one on the left is fast but the others are all slow.
		
		If you select a character and release your finger right after the character
		starts to be read out, you will hear the voice "Key not selected".
