''' 
version 00.35 is available with

modifications
  - change one phrase: “こんばん”🌙”→”こんばんは🌙”
...
```one limitation bothers me: if you want to modify, add, delete phrases, you will have to ask me, whereas I could provide reading a Fixed_Phrases.txt file that you could update yourself locally in  the script folder, whenever you want.```
