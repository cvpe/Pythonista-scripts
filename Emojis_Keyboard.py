''' 
version **00.39** is available with

modifications
  - no more space between rows and top (iPad only) and bottom Pythonista rows
    => buttons a little bigger
  - flicked buttons above first row resized to be visible 
  - Number page.
    First line. “カタカナ”,”¥”,”1”,”2”,”3”,”（”
    Second line. “ABC”,”%”,”4”,”5”,”6”,”）”,”左削除”
    Third line. “平仮名”,”$”,”7”,”8”,”9”,”＝”,”漢字”
    Fourth line. “絵文字”,”+”,”-“,”0”,”×”,”÷”,”return”
  - Alphabet page.
    First line. ”カタカナ”,”(“,”@“,”a”,”d”,”)”
    Second line. “平仮名”,”&”,”g”,”j”,”m”,”#”,”左削除”
    Third line. “数字”,”CapsLock”,” p”,”t”,”w”,”.”
    Fourth line. “絵文字”,”shift”,”!”,”?”,”/“,”space”,”return”
  - Katakana not yet built
  
```About Katakana, could you also describe all rows because even if I understand the positions of Katakana letters, I don't know which function keys you need and where```
 
 ```I have a problem with small keys. 
As you changed positions of original keys, some sub-keys, if at same position, fall at same place of others. 
Could you also define which keys in which row```
...
class MyView(ui.View):
	...
	def dimensions(self):				
		...
		keyboards = {'hiragana':[
			...
			[1,3,'カタカナ', self.b_katakana_action,''],
			[2,3,'小文字',self.smallKey,''],
			...
			[2,3,'平仮名', self.b_hiragana_action,''],
			[5,3,"。、",self.typeChar,"、？！ "] 	
						...
						if flick[i] != ' ':
							...
							if kbd in self.small_keys:
								if title in self.small_keys[kbd]:
									...
									bs = self.make_button(xx,yy,dx,ddy,ts,self.typeChar,super=self.vs[kbd])
									bs.name = 'smallkey'
									bs.hidden = True					
