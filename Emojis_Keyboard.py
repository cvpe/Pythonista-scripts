''' 
version **00.50** is available with

modifications
  - from the symbol page, place the button to return to the Hiragana page to the
    right of the ")" button.
    
corrections
  - If you convert five or more Kanji characters, the Kanji selection field
    becomes too wide. Up, down, and OK buttons are hidden
    Font size will be set to show all letters of temporary storage and first
    element of list will never hide buttons
